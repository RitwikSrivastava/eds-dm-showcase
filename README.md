# EDS Dynamic Media Showcase
An Edge Delivery Services demo site showcasing Dynamic Media asset delivery and optimization via Approach B (https://www.aem.live/docs/media#approach-b-asset-management-delivery).

## Environments
- Preview: https://main--eds-dm-showcase--RitwikSrivastava.aem.page/
- Live: https://main--eds-dm-showcase--RitwikSrivastava.aem.live/
...
1. Open the `eds-dm-showcase` directory in your favorite IDE and start coding :)
